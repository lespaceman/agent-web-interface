...
function initializeServer(): BrowserAutomationServer {
  ...
  server.registerTool(
    'list_tabs',
    {
      title: 'List Tabs',
      description:
        'List all open browser tabs with their page_id, URL, and title. Use when working with multiple tabs or to get the page_id for targeting a specific tab.',
  ...
  server.registerTool(
    ...
    {
      title: 'Close Page',
      description: 'Close a browser tab. Use list_tabs first to get the page_id.',
